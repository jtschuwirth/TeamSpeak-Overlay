...
def leer_mensajes():
    ...
    for line in loglines:
        ...
        if "You were kicked from the server" in line:
            return ["", "", "You were kicked from the server", "", "server", "serverlog"]
        elif "Disconnected from server" in line:
            return ["", "", "Disconnected from the server", "", "server", "serverlog"]
        elif "Connected to Server:" in line:
            return ["", "", "Connected to the server", "", "server", "serverlog"]
        else:
            continue
